...
class Configurator:
    ...
    def _create_config(self):
        ...
        if self.file_exists:
            ...
            self.logger.event('debug', 'FCMonitor: Configuration created!')
        else:
            self.logger.event('error', "FCMonitor: Configuration file doesn't exists")
    ...
    def get_value(self, section=None, option=None):
        try:
            ...
            self.logger.event('error', f'FCMonitor: get setting {section}, {option} error {e}')
            return None
